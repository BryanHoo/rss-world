...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      'inline-flex h-9 items-center justify-center rounded-xl bg-[color-mix(in_oklab,var(--color-muted)_74%,white_26%)] p-1 text-muted-foreground',
      className,
    )}
    {...props}
  />
